      ...
      <main className={styles.container}>
        ...
        <section className={styles.section}>
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            Enfoque estratégico para clínicas
          </motion.h2>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Las clínicas requieren implementar modelos de gestión financiera más
            eficientes que les permitan mejorar el recaudo, optimizar procesos y
            mantener la sostenibilidad del negocio en el tiempo.
          </motion.p>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            Cada vez más clínicas en Colombia están adoptando enfoques
            estratégicos para fortalecer su flujo de caja y mejorar su
            rentabilidad.
          </motion.div>
        </section>
